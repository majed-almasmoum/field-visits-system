...
// Validate ../../app/auth/callback/logout/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/auth/callback/logout">> = Specific
  const handler = {} as typeof import("../../app/auth/callback/logout/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
